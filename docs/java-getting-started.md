...
Rundoc.configure do |config|
  config.project_root = "marvel-web-project"
  config.filter_sensitive(email => "developer@example.com")
end
```
<!--
  rundoc src:
  https://github.com/heroku/marvel-web-project/blob/master/marvel-web-project.md

  Command:
  $ rundoc build --path marvel-web-project.md
-->
...
```term
:::>- $ git clone https://git.heroku.com/marvel-web-project.git
:::>- $ cd marvel-web-project
:::-- $ git fetch
...
The demo app you deployed already has a `pom.xml` ([see it here](https://git.heroku.com/marvel-web-project.git/blob/master/pom.xml)). Here's an excerpt:
...
[Here's the final source code](https://git.heroku.com/marvel-web-project.git/blob/localchanges/src/main/java/com/example/Main.java) for `Main.java` - yours should look similar.  [Here's a diff](https://git.heroku.com/marvel-web-project.git/compare/localchanges) of all the local changes you should have made.
